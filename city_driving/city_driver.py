...
# ORIGINALLY COPIED OVER FROM PARKING_CONTROLLER.PY
class CityDrivingController():
    """
    ...
    def __init__(self):
        ...
        self.detect_stop_pub = rospy.Publisher("/detect_stop",
                                               Bool, queue_size=10)
...
if __name__ == '__main__':
    try:
        rospy.init_node('CityDrivingController', anonymous=True)
        CityDrivingController()
        rospy.spin()
